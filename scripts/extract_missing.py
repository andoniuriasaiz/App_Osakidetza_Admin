...
JSON_FILE = ROOT / 'soluciones_chatelac_faltantes_definitivo.json'
PUBLIC_DIR = ROOT / 'public'
DATA_DIR = PUBLIC_DIR / 'data'

if not JSON_FILE.exists():
    print(f"Error: No se encontró {JSON_FILE}. Debes descargar las imágenes faltantes primero.")
    exit(1)
...
print(f"Extracted {saved_images} NEW images.")
...
for mod, updates in json_updates.items():
    ...
    print(f"Updated {updated} missing questions in {mod}.json")
